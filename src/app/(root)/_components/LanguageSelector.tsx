    ...
    return (
        <div className="relative" ref={dropdownRef}>
            <motion.button
                ...
                className={`group relative flex items-center gap-3 px-4 py-2.5 bg-[#00000]/80 
      rounded-lg transition-all 
       duration-200 border-dashed border-2  border-gray-700 hover:border-gray-700
       ${!hasAccess && language !== "javascript" ? "opacity-50 cursor-not-allowed" : ""}`}
        ...
        rounded-lg opacity-0 group-hover:opacity-100 transition-opacity"
                ...
                <span className="text-gray-200 min-w-[80px] text-sm text-left group-hover:text-white transition-colors">
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="absolute top-full left-0 mt-2 w-64 bg-[#00000]/95 backdrop-blur-xl
           rounded-xl border border-[#313244] shadow-2xl py-2 z-50"
                    >
                      ...
                      ${language === lang.id ? "bg-violet-500/10 text-violet-500" : "text-gray-300"}
